...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    defaults = cli_config_argv(
        config_path, schema="molvid.evaluate.v1",
        allowed_fields=(
            "checkpoint", "checkpoint_sha256", "codec", "codec_sha256",
            "manifest_root", "valid_index", "history", "steps", "seed",
            "rollout_track", "rollout_seed", "device", "output_root", "plot",
        ),
        path_fields=(
            "checkpoint", "codec", "manifest_root", "rollout_track", "output_root",
        ),
