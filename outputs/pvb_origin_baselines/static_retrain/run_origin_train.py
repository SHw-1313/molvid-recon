#!/usr/bin/env python
"""Run the untouched PVB_origin train.py with an output-local data adapter."""
...
ADAPTER_PATH = OUTPUT_ROOT / "streaming_origin_adapter_v2.py"


def _load_adapter():
    name = "pvb_origin_streaming_adapter"
...
def main() -> None:
    ...
    # This is the only replacement: the original train.py, DynamicTrainer,
    # collator, model, optimizer, and checkpoint code remain untouched.
    ...
    # MixDatasetWrapper reads this attribute during construction; train.py
    # passes the original module-level collator to DataLoader separately.
